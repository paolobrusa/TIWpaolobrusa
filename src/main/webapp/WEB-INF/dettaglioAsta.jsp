                                ...
                                <table class="articles-table">
                                    ...
                                    <c:forEach var="articolo" items="${articoli}">
                                        <tr class="article-row">
                                            <td class="asta-id">${articolo.code}</td>
                                            <td class="article-name">${articolo.name}</td>
                                            <td class="price">€ <fmt:formatNumber value="${articolo.price}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                            ...
                            <table class="offerte-table">
                                ...
                                <c:forEach var="offerta" items="${offerte}" varStatus="status">
                                    <tr class="offerta-row ${status.index == 0 && asta.state == 'chiusa' ? 'winning-row' : ''}">
                                        <td class="user-name">${offerta.usnUser}</td>
                                        <td class="min-bid">€ <fmt:formatNumber value="${offerta.bid}"/></td>
                                        <td class="date">
